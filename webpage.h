...
<head>
  ...
  <style>
    ...
    h1 { font-size: 2.2em; }
    p, code, pre { font-size: 1.2em; word-break: break-word; }
    pre { background: #f7f9fa; padding: 1.3em; border-radius: 10px; color: #005500; text-align: left; overflow-x: auto; }
    code { background: #eef4f8; padding: 0.5em 0.5em; border-radius: 5px; font-family: Consolas, monospace; }
  </style>
</head>
<body>
  <div class="card">
